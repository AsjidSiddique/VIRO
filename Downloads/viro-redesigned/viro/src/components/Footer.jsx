        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              ...
              <li><a href="/admin"  className="hover:text-purple-400 transition-colors flex items-center gap-1.5">⚙️ Admin</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-xs">
              {[
                ...
                { city: 'Chichawatni',free: '2000+', color: '#8B5CF6' },
                { city: 'Vehari',      free: '1500+', color: '#F97316' },
                { city: 'Gaggo',       free: '1200+', color: '#EC4899' },
              ].map(c => (
